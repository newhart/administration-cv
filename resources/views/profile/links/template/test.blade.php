...
<head>
    ...
    <title>Haritiana portfolio</title>
    <!-- font icons -->
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    <img src="{{asset('assets/imgs/avatar.jpg')}} " alt="avatar-image" class="brand-img">
                    <li class="brand-txt">
                        <h5 class="brand-title">Haritiana Randria</h5>
                ...
                <div class="portfolio-container"> 
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="{{asset('assets/imgs/web-1.jpg')}} " class="img-fluid" alt="web1">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="{{asset('assets/imgs/web-2.jpg')}}" class="img-fluid" alt="web2">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="{{asset('assets/imgs/advertising-2.jpg')}}" class="img-fluid" alt="">                         
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web">
                        <div class="portfolio-item">
                            <img src="{{asset('assets/imgs/web-4.jpg')}} " class="img-fluid" alt="">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising"> 
                        <div class="portfolio-item">
                            <img src="{{asset('assets/imgs/advertising-1.jpg')}} " class="img-fluid" alt="">                               
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="{{asset('assets/imgs/web-3.jpg')}} " class="img-fluid" alt="">  
                           <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="{{asset('assets/imgs/advertising-3.jpg')}} " class="img-fluid" alt="">       
                           <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="{{asset('assets/imgs/branding-3.jpg')}} " class="img-fluid" alt="branding">   
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src=" {{asset('assets/imgs/branding-4.jpg')}} " class="img-fluid" alt="branding-four">                      
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="{{asset('assets/imgs/branding-5.jpg')}} " class="img-fluid" alt="branding-five">          
                            <div class="content-holder">
            ...
            <div class="row">
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="{{asset('assets/imgs/blog1.jpg')}} " alt="blog-one">
                    </div>
                    <div class="content-holder">
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="{{asset('assets/imgs/blog2.jpg')}} " alt="blog-tow">
                    </div>
                    <div class="content-holder">
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="{{asset('assets/imgs/blog3.jpg')}} " alt="blog-3">
                    </div>
                    <div class="content-holder">
